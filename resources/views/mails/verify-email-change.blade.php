...
<body>
    <div class="email-container">
        ...
        <div class="content">
            メールアドレス変更のリクエストを受け付けました。<br>
            以下のボタンをクリックして、変更を確定してください。
        </div>

        <div class="info-box">
            <div class="info-item">
                <div class="info-label">新しいメールアドレス</div>
                <div class="info-value">{{ $newEmail }}</div>
            </div>
        </div>

        <div class="button-container">
            <a href="{{ $verificationUrl }}" class="button" style="color: #ffffff !important;">メールアドレスを変更する</a>
        </div>
        ...
        <div class="warning-box">
            ...
            <div class="warning-item">・このリンクは30分間有効です</div>
            <div class="warning-item">・このリンクを第三者と共有しないでください</div>
            <div class="warning-item">・このメールに心当たりがない場合は、アカウントのセキュリティに問題がある可能性があります。パスワードの変更をお勧めします</div>
        </div>
