...
<body>
    <div class="email-container">
        ...
        <div class="button-container">
            <a href="{{ $data['url'] }}" class="button" style="color: #ffffff !important;">パスワードを再設定する</a>
        </div>
        ...
        <div class="steps-box">
            <div class="steps-title">■ 再設定手順</div>
            <div class="step-item" data-step="1.">上記のボタンまたはURLをクリックしてください</div>
            <div class="step-item" data-step="2.">表示された画面で新しいパスワードを入力してください</div>
            <div class="step-item" data-step="3.">「設定する」ボタンをクリックして完了です</div>
        </div>

        <div class="warning-box">
            <div class="warning-title">■ ご注意</div>
            <div class="warning-item">・このリンクを第三者と共有しないでください</div>
            <div class="warning-item">・リンクの有効期限が切れた場合は、再度パスワード再設定をお試しください</div>
