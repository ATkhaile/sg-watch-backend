...
return [
    ...
    'list' => [
        'message' => 'User Point Daily List',
    ],
    'find' => [
        'message' => 'User Point Daily detail',
    ],
    'save' => [
        'success' => 'User Point Daily created successfully.',
        'failed' => 'Failed to create User Point Daily.',
    ],
    'update' => [
        'success' => 'User Point Daily updated successfully.',
        'failed' => 'Failed to update User Point Daily.',
    ],
    'delete' => [
        'success' => 'User Point Daily deleted successfully.',
        'failed' => 'Failed to delete User Point Daily.',
    ],
];