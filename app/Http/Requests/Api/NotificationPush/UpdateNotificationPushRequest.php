...
class UpdateNotificationPushRequest extends ApiFormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'remove_attach_file' => 'nullable|boolean',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'remove_image.boolean'       => __('notification_push.validation.remove_image.boolean'),
            ...
            'remove_attach_file.boolean' => __('notification_push.validation.remove_attach_file.boolean'),
        ];
    }
}
