...
class PermissionDetailEntity
{
    public function __construct(
        ...
        private ?string $usecaseGroup = null,
    ...
    public function jsonSerialize(): array
    {
        ...
        if ($this->usecaseGroup !== null) {
            $result['usecase_group'] = $this->usecaseGroup;
        }
    ...
    public function setUsecaseGroup(?string $usecaseGroup): self
    {
