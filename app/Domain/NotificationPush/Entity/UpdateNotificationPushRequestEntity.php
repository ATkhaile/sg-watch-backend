...
class UpdateNotificationPushRequestEntity
{
    public function __construct(
        public readonly string $title,
        public readonly string $message,
        public readonly mixed $img_path,
        ...
        public readonly bool $remove_image = false,
        ...
        public readonly bool $remove_attach_file = false,
    ) {}
}
