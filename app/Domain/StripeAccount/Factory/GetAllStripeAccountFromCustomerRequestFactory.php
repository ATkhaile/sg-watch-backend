...
class GetAllStripeAccountFromCustomerRequestFactory
{
    public function createFromRequest(GetAllStripeAccountFromCustomerRequest $request, ?string $activeUserStripeAccountId): StripeAccountEntity
    {
        $sortOrder = [];
        ...
        return new StripeAccountEntity(
            ...
            sortOrder: $sortOrder,
            activeUserStripeAccountId: $activeUserStripeAccountId
        );
    }
}
