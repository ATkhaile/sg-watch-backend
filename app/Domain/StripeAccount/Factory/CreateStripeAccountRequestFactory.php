...
class CreateStripeAccountRequestFactory
{
    public function createFromRequest(CreateStripeAccountRequest $request): CreateStripeAccountRequestEntity
    {
        ...
        return new CreateStripeAccountRequestEntity(
