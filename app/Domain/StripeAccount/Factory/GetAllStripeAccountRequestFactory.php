...
class GetAllStripeAccountRequestFactory
{
    public function createFromRequest(GetAllStripeAccountRequest $request): StripeAccountEntity
    {
        $sortOrder = [];
        ...
        return new StripeAccountEntity(
            searchUserId: $request->input('search_user_id'),
